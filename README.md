...
- 英文→中文选项仅保留英文词性缩写（如 `n.`、`v.`、`adj.`、`prep.`）及清洗后的中文释义和标点，不显示英文单词、音标或英文括注；清洗后无中文的候选不参与出题。中文→英文选项显示英文单词、标准词性缩写和音标。
...
- 优化手机全屏做题：四个选择项在窄屏采用紧凑两列布局，顶部仅显示“第 X / Y 题”（记忆模式显示“剩余 N 词”）；全屏题面支持左右滑动切换上一题/下一题，点击选项、输入框、导图和画布时不触发滑动。
